...
async function testReporteActividadEmisoresPostman() {
  try {
    console.log('🔍 Probando endpoint con parámetros de Postman...');
    
    // Parámetros exactos de la URL: /api/v1/reportes/actividad-emisores?periodo=7&limit=10
    const filtros = {
      periodo: 7,
      limit: 10,
      formato: 'json'
    ...
    console.log('📋 Filtros de Postman:', filtros);
    ...
    console.log('   GET /api/v1/reportes/actividad-emisores?periodo=7&limit=10');
...
if (require.main === module) {
  testReporteActividadEmisoresPostman()
    .then(() => {
...
module.exports = { testReporteActividadEmisoresPostman }; 